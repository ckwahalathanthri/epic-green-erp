...
//    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER')")
    ...
    @GetMapping
//    @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'USER')")
    public ResponseEntity<ApiResponse<Page<TaxRateResponse>>> getAllTaxRates(@PageableDefault(size = 10) Pageable pageable) {
        Page<TaxRateResponse> response = taxRateService.getAllTaxRates(pageable);
