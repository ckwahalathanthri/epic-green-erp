...
////            SalesOrderItem orderItem = item.getDispatchItem();
//            BigDecimal currentDelivered = item.getQuantityDispatched()!= null ?
//                item.getQuantityDispatched() : BigDecimal.ZERO;
//            item.setQuantityDispatched(currentDelivered.add(item.getQuantityDispatched()));
...
////        DispatchItem orderItem = dispatchItemRepository.findById(request.getOrderItemId());
